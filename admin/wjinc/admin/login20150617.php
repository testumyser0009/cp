...
body {
	...
	background: url("/skin/admin/images/beijing.jpg") 70% 0 no-repeat, url("/skin/admin/images/beijing.jpg")repeat-x;
}
...
#login {
	...
	background: url("/skin/admin/images/login.jpg") 70% 0 no-repeat, url("/skin/admin/images/login.jpg")repeat-x;
}
...
<form id="login" target="ajax" onajax="checkLogin" call="doLogin" action="/admin778899.php/user/checkLogined" method="post" >
    ...
    <fieldset id="inputs">
		...
		<div style="position:absolute; margin-top:-105px; margin-left:45% "><img id="imgcode" align="absmiddle" onClick="this.src='/admin778899.php/user/vcode/'+(new Date()).getTime()" title="看不清楚，换一张图片" src="/admin778899.php/user/vcode/<?=$this->time?>" width="120" height="43"/></div>
    </fieldset>
    <fieldset id="actions">

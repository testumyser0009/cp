...
<body>
	...
	<aside id="sidebar" class="column">
		...
		<hr/>
		<?php if ($this->user['uid'] == 1 || in_array('ywls', $this->permission)) {?>
		<h3>业务流水<a>＋</a></h3>
		...
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('kjsj', $this->permission)) {?>
		<h3>开奖数据<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
		...
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('sjgl', $this->permission)) {?>
        <h3>时间管理<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
			<?php foreach($this->getRows("select id,title from {$this->prename}type where enable=1 and isDelete=0 order by sort") as $type){ ?>
		...
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('sjtj', $this->permission)) {?>
		<h3>数据统计<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
			<li><a href="countData/index" class="s_b_1 bq current">统计概况</a></li>
			<li><a href="countData/betDate" class="s_b_2 bq">统计报表</a></li>
			<li><a href="countData/testList" class="s_b_2 bq">开奖检测</a></li>
		</ul>
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('dlfcgl', $this->permission)) {?>
		<h3>代理分成管理<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
        	<li><a href="bonus/bonuslist" class="bq jf_b_2">分成统计</a></li>
		</ul>	
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('yhgl', $this->permission)) {?>	
        <h3>用户管理<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
		...
		<?php }?>
		<?php if($this->user['username']=="admin"){?>
		<h3>模板管理<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
		...
		<?php }?>
		<?php if ($this->user['uid'] == 1 || in_array('xtsz', $this->permission)) {?>
		<h3>系统设置<a>＋</a></h3>
		<ul class="toggle" style="display:none;">
		...
		<footer>
			<hr />
			<p><strong>Copyright &copy; 2015后台管理系统</strong></p>
		</footer>

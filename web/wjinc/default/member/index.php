...
<div class="header_box">
	...
	<div class="sub" id="homeCateMenus">
		...
		<div id="cate_menus_72" class="show cate_menu">
			<a class="selected" href="/game/jspk10/index.html" onclick="HomeMenu.selCateMenuClass(this);" target="framePage" cate_id="1">两面盘</a>
			|
			<a href="/game/jspk10/sol.html" target="framePage" onclick="HomeMenu.selCateMenuClass(this);" cate_id="2">单号1~10</a>
			|
			<a href="/game/jspk10/com.html" target="framePage" onclick="HomeMenu.selCateMenuClass(this);" cate_id="3">冠亚组合</a>
		</div>
...
<div class="main clearfix">
	...
	<div class="siderbar" id="left_main">
		...
		<?php 
			...
			<a class="supportbtn" onclick="window.open('http://api1.pop800.com/chat/307374','','width=800,height=500');" style="cursor:pointer " target="_blank">

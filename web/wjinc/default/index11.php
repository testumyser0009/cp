...
<link href="static/css/index.pack.min.css?v=1610251709" rel="stylesheet" />
...
<div class="header_box">
	<div class="header_top">
	  ...
	  <!-- 	 <span><a onclick="SoundManage.voiceSwitch()" id="countdown_sound" style="cursor:pointer;">切换声音
			<ul>
				<li>声音1</li>
				<li>声音2</li>
				<li>声音3</li>
...
<div class="main clearfix">
	...
	<div class="siderbar" id="left_main">
		...
		<?php 
			...
			<a href="javascript:onlineService();" class="supportbtn" style="display: block;">

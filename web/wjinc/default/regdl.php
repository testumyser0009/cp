		...
		<div class="header">
			<div class="logo">
				<object id="FlashA" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="278" height="110" class="flash">
					<param name="movie" value="http://98bei.com/login_file/reglogo.swf">
					<param name="quality" value="high">
					<param name="wmode" value="transparent">
					<param name="swfversion" value="6.0.65.0">
					<!--[if !IE]>-->
					<object type="application/x-shockwave-flash" data="http://98bei.com/login_file/reglogo.swf" width="260" height="87">
						<!--<![endif]-->
						<param name="quality" value="high">
						<param name="wmode" value="transparent">
						<param name="swfversion" value="6.0.65.0">
				...
				<div class="notice">
					<h2>最新公告：</h2>
					<div class="cont">
						<marquee id="noticeDiv" direction="left" scrollamount="4" onmouseover="this.stop()" onmouseout="this.start()">欢迎进入98彩票网，本站网址www.66acp.com</marquee>
					</div>
				</div>
			</div>

			<div style="width: 1000px; margin: 0  auto; overflow: hidden;"><img src="http://98bei.com/files/toubu.png"></div>
				...
				<div class="kaihu">
					<div class="kaihuin">
						...
						<form id="main" method="post" onajax="registerBeforSubmit" enter="true" call="registerSubmit" target="ajax" name="main" action="/index.php/user/registered">
                            ...
                            <input type="hidden" name="parentId" id="parentId" value="<?=$args[0]?>" />
                            <input type="hidden" name="lid" id="lid" value="<?=$this->lid?>"  />
		...
		$("#regBtn").click(function(){
			var theForm = $("#main");
				...
				if (theForm.validationEngine('validate')) {
						...
						// $('#main').submit();
						$.post("/index.php/user/registered",
                            {coinpwd:reg_code,keys:"add",website:"18b18.com",username:username,password:password,
						cpasswd:password2,email:email,name:name,Checkbox:Checkbox,parentId:parentId,lid:lid
							...
							//}
						}).error(function(data) { alert(JSON.stringify(data)+"用户名已经存在"); });
					}

...
<script type="text/javascript">
	var data = "1：双赢彩票官方交流群【5000777】欢迎广大新老用户入群交流。 ";
...
<body>
	<div class="minbox">
		...
		<div class="wrapper">
			...
			<div class="header">
				<div class="logo">
					<object id="FlashA" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="252" height="87" class="flash">
						<param name="movie" value="/Public/Home/Img/reglogo.swf">
						<param name="quality" value="high">
						<param name="wmode" value="transparent">
						<param name="swfversion" value="6.0.65.0">
						<!--[if !IE]>-->
						<object type="application/x-shockwave-flash" data="https://www.555123.com/Public/Home/Img/reglogo.swf" width="252" height="87">
							<!--<![endif]-->
							<param name="quality" value="high">
							<param name="wmode" value="transparent">
							<param name="swfversion" value="6.0.65.0">
				...
				<div class="notice">
					<h2>最新公告：</h2>
					<div class="cont">
						<marquee id="noticeDiv" direction="left" scrollamount="4" onmouseover="this.stop()" onmouseout="this.start()">1：双赢彩票官方交流群【5000777】欢迎广大新老用户入群交流。 </marquee>
					</div>
				</div>
			</div>
						...
						<form id="main" method="post" onajax="registerBeforSubmit" enter="true" call="registerSubmit" target="ajax" name="main" action="/index.php/user/registered">
							...
							<table class="zhucetable">
								<tbody><tr>
									...
									<td width=""><input size="40" name="username" id="reg_username" maxlength="15" class="validate[required,custom[onlyLetterNumber],minSize[6],maxSize[15]] zucenpt" type="text"> <span class="pl8 f15">账号规则：账号必须为6-15为数字和字母组合</span></td>

								</tr>
								<tr>
									<td width="96"><div class="tar f15">登陆密码：</div></td>
									<td width=""><input name="password" id="reg_password" maxlength="15" size="40" class="validate[required,minSize[6],maxSize[15]] zucenpt" type="password"> <span class="pl8 f15">密码规则：密码长度要有6-15个字符，以及必须含有数字和字母组合</span>
									</td>

								</tr>
								<tr>
									<td width="96"><div class="tar f15">确认密码：</div></td>
									<td width=""><input name="cpasswd" id="reg_password1" maxlength="15" size="40" class="validate[required,equals[reg_password]] zucenpt" type="password"> <span class="pl8 f15">确定密码</span></td>

								</tr>
								<tr>
									<td width="96"><div class="tar f15">真实姓名：</div></td>
									<td width=""><input id="reg_name" name="name" size="40" maxlength="10" class="validate[required] zucenpt"> <span class="pl8 f15">姓名必须与你用于提款的银行户口名字一致，否则无法提款</span></td>

								</tr>
								<tr>
									<td width="96"><div class="tar f15" >电子邮箱：</div></td>
									<td width=""><input id="reg_email" name="email" size="40" maxlength="30" class="validate[required,custom[email],minSize[4]] zucenpt" type="text"> <span class="pl8 f15">email格式：888888@qq.com</span>
									</td>
								</tr>
	 							<tr>
									<td width="96"><div class="tar f15">取款密码：</div></td>
									<td width=""><input id="reg_code" name="coinpwd" size="40" maxlength="10" class="validate[required] zucenpt">
									</td>
								...
								<tr>
									...
									<td width=""><input type="button" name="regBtn1" id="regBtn" class="subbtn fl mr12" value=""> <a href="https://www.555123.com/userlogin.html" class="wydeng">我要登录</a></td>
		...
		$("#regBtn").click(function(){
			var theForm = $("#main");
				...
				if (theForm.validationEngine('validate')) {
						...
						var password2 = $("#reg_password1").val();
						...
						$.post("/index.php/user/registered",{reg_code,reg_code,keys:"add",website:"18b18.com",username:username,password:password,

...
$(window).load(function() {
    ...
    if(pageSite && (pageSite.toLowerCase() == 'game' || pageSite.toLowerCase() =='game3dfight')) {
        var unityObjectUrl = "cl/js/game/UnityObject.html";
...
function HotNewsHistory() {
     ...
     window.open('cl/index40e6.html?module=MFunction&amp;method=ShowHotNewsHistory', 'HotNewsHistory', features);
}
...
function GetGameQuantity(color){
   $.getJSON('cl/indexb3d2.html?module=MCountGameNums&amp;method=CountGames',{ "noCache": Math.random()}, function(data){
...
function GetFavorQuantity(color) {
    $.getJSON('cl/indexdaa8.html?module=MCountGameNums&amp;method=CountFavoGames', {"noCache": Math.random()}, function(data) {
